...
const serbianVocabularyData = {
    '1-3': {
        family: {
            title: 'Породица',
            description: 'Научи речи за чланове породице.',
            swedish: 'Familj',
            items: [
                { id: 3001, word: 'мајка', translation: 'mamma' },
                { id: 3002, word: 'отац', translation: 'pappa' },
                { id: 3003, word: 'сестра', translation: 'syster' },
                { id: 3004, word: 'брат', translation: 'bror' },
                { id: 3005, word: 'бака', translation: 'farmor/mormor' },
                { id: 3006, word: 'деда', translation: 'farfar/morfar' },
                { id: 3007, word: 'тетка', translation: 'moster/faster' },
                { id: 3008, word: 'стриц', translation: 'farbror' },
                { id: 3009, word: 'ујак', translation: 'morbror' },
                { id: 3010, word: 'беба', translation: 'bebis' },
            ],
        },
        colors: {
            title: 'Боје',
            description: 'Откриј називе за различите боје.',
            swedish: 'Färger',
            items: [
                { id: 3011, word: 'црвена', translation: 'röd' },
                { id: 3012, word: 'плава', translation: 'blå' },
                { id: 3013, word: 'зелена', translation: 'grön' },
                { id: 3014, word: 'жута', translation: 'gul' },
                { id: 3015, word: 'црна', translation: 'svart' },
                { id: 3016, word: 'бела', translation: 'vit' },
                { id: 3017, word: 'наранџаста', translation: 'orange' },
                { id: 3018, word: 'љубичаста', translation: 'lila' },
                { id: 3019, word: 'браон', translation: 'brun' },
                { id: 3020, word: 'сива', translation: 'grå' },
            ],
        },
    },
    '4-6': {},
