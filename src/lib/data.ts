...
export const data: LanguageData = {
  bosnian: {
    '1-3': {
      vocabulary: [
        ...
        { id: 5, word: 'jabuka', translation: 'äpple', audio: '' },
        { id: 6, word: 'auto', translation: 'bil', audio: '' },
        { id: 7, word: 'mačka', translation: 'katt', audio: '' },
        { id: 8, word: 'pas', translation: 'hund', audio: '' },
        { id: 9, word: 'lopta', translation: 'boll', audio: '' },
        { id: 10, word: 'sunce', translation: 'sol', audio: '' },
        { id: 11, word: 'voda', translation: 'vatten', audio: '' },
        { id: 12, word: 'stolica', translation: 'stol', audio: '' },
        { id: 13, word: 'sat', translation: 'klocka', audio: '' },
        { id: 14, word: 'most', translation: 'bro', audio: '' },
        { id: 15, word: 'drvo', translation: 'träd', audio: '' },
        { id: 16, word: 'cvijet', translation: 'blomma', audio: '' },
        { id: 17, word: 'prozor', translation: 'fönster', audio: '' },
        { id: 18, word: 'vrata', translation: 'dörr', audio: '' },
        { id: 19, word: 'nebo', translation: 'himmel', audio: '' },
        { id: 20, word: 'trava', translation: 'gräs', audio: '' },
        { id: 22, word: 'mlijeko', translation: 'mjölk', audio: '' },
        { id: 23, word: 'šećer', translation: 'socker', audio: '' },
        { id: 24, word: 'so', translation: 'salt', audio: '' },
        { id: 25, word: 'prijatelj', translation: 'vän', audio: '' },
        { id: 26, word: 'avion', translation: 'flygplan', audio: '' },
        { id: 27, word: 'bicikl', translation: 'cykel', audio: '' },
        { id: 28, word: 'voz', translation: 'tåg', audio: '' },
        { id: 29, word: 'brod', translation: 'båt', audio: '' },
        { id: 30, word: 'krevet', translation: 'säng', audio: '' },
        { id: 31, word: 'telefon', translation: 'telefon', audio: '' },
        { id: 32, word: 'televizor', translation: 'TV', audio: '' },
  ...
  croatian: {
    '1-3': {
      vocabulary: [
        { id: 1, word: 'kava', translation: 'kaffe', audio: '' },
        { id: 2, word: 'kruh', translation: 'bröd', audio: '' },
        { id: 3, word: 'škola', translation: 'skola', audio: '' },
        { id: 4, word: 'kuća', translation: 'hus', audio: '' },
        { id: 5, word: 'knjiga', translation: 'bok', audio: '' },
        { id: 6, word: 'jabuka', translation: 'äpple', audio: '' },
        { id: 7, word: 'automobil', translation: 'bil', audio: '' },
        { id: 8, word: 'mačka', translation: 'katt', audio: '' },
        { id: 9, word: 'pas', translation: 'hund', audio: '' },
        { id: 10, word: 'lopta', translation: 'boll', audio: '' },
        { id: 11, word: 'sunce', translation: 'sol', audio: '' },
        { id: 12, word: 'voda', translation: 'vatten', audio: '' },
        { id: 13, word: 'stolica', translation: 'stol', audio: '' },
        { id: 14, word: 'sat', translation: 'klocka', audio: '' },
        { id: 15, word: 'most', translation: 'bro', audio: '' },
        { id: 16, word: 'stablo', translation: 'träd', audio: '' },
        { id: 17, word: 'cvijet', translation: 'blomma', audio: '' },
        { id: 18, word: 'prozor', translation: 'fönster', audio: '' },
        { id: 19, word: 'vrata', translation: 'dörr', audio: '' },
        { id: 20, word: 'nebo', translation: 'himmel', audio: '' },
        { id: 21, word: 'trava', translation: 'gräs', audio: '' },
        { id: 22, word: 'mlijeko', translation: 'mjölk', audio: '' },
        { id: 23, word: 'šećer', translation: 'socker', audio: '' },
        { id: 24, word: 'sol', translation: 'salt', audio: '' },
        { id: 25, word: 'prijatelj', translation: 'vän', audio: '' },
        { id: 26, word: 'zrakoplov', translation: 'flygplan', audio: '' },
        { id: 27, word: 'bicikl', translation: 'cykel', audio: '' },
        { id: 28, word: 'vlak', translation: 'tåg', audio: '' },
        { id: 29, word: 'brod', translation: 'båt', audio: '' },
        { id: 30, word: 'krevet', translation: 'säng', audio: '' },
        { id: 31, word: 'telefon', translation: 'telefon', audio: '' },
        { id: 32, word: 'televizor', translation: 'TV', audio: '' },
  ...
  serbian: {
    '1-3': {
      vocabulary: [
        { id: 1, word: 'kafa', translation: 'kaffe', audio: '' },
        { id: 2, word: 'hleb', translation: 'bröd', audio: '' },
        { id: 3, word: 'hiljada', translation: 'tusen', audio: '' },
        { id: 4, word: 'porodica', translation: 'familj', audio: '' },
        { id: 5, word: 'reka', translation: 'flod', audio: '' },
        { id: 6, word: 'selo', translation: 'by', audio: '' },
        { id: 7, word: 'škola', translation: 'skola', audio: '' },
        { id: 8, word: 'kuća', translation: 'hus', audio: '' },
        { id: 9, word: 'knjiga', translation: 'bok', audio: '' },
        { id: 10, word: 'jabuka', translation: 'äpple', audio: '' },
        { id: 11, word: 'voda', translation: 'vatten', audio: '' },
        { id: 12, word: 'stolica', translation: 'stol', audio: '' },
        { id: 13, word: 'drvo', translation: 'träd', audio: '' },
        { id: 14, word: 'cvet', translation: 'blomma', audio: '' },
        { id: 15, word: 'prozor', translation: 'fönster', audio: '' },
        { id: 16, word: 'vrata', translation: 'dörr', audio: '' },
        { id: 17, word: 'nebo', translation: 'himmel', audio: '' },
        { id: 18, word: 'trava', translation: 'gräs', audio: '' },
        { id: 19, word: 'mleko', translation: 'mjölk', audio: '' },
        { id: 20, word: 'šećer', translation: 'socker', audio: '' },
        { id: 21, word: 'so', translation: 'salt', audio: '' },
        { id: 22, word: 'drug', translation: 'vän', audio: '' },
        { id: 26, word: 'avion', translation: 'flygplan', audio: '' },
        { id: 27, word: 'bicikl', translation: 'cykel', audio: '' },
        { id: 28, word: 'voz', translation: 'tåg', audio: '' },
        { id: 29, word: 'brod', translation: 'båt', audio: '' },
