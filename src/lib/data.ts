  ...
  croatian: {
    '1-3': {
      ...
      spelling: [
        ...
        { id: 35, sentence: 'More je ___ i plavo.', blank: 'veliko', options: ['veliko', 'velko', 'velik'] },
        { id: 36, sentence: 'Ivan ima ___ bicikl.', blank: 'novi', options: ['novi', 'nov', 'nov'] },
        { id: 37, sentence: 'Boli me ___.', blank: 'želudac', options: ['želudac', 'želudec', 'želudac'] },
        { id: 38, sentence: 'Idemo na izlet u ___.', blank: 'nedjelju', options: ['nedjelju', 'nedilju', 'nedjelju'] },
        { id: 39, sentence: 'Ovo je priča o ___.', blank: 'dječaku', options: ['dječaku', 'dečaku', 'dječaku'] },
        { id: 40, sentence: 'Pas laje na ___.', blank: 'mjesec', options: ['mjesec', 'misec', 'mjesec'] },
        { id: 41, sentence: 'Ona je ___ od njega.', blank: 'pametnija', options: ['pametnija', 'pametnija', 'pametnia'] },
        { id: 42, sentence: 'Na stolu je ___ cvijeća.', blank: 'buket', options: ['buket', 'buket', 'buket'] },
      ...
      sentences: [
        ...
        { id: 36, sentence: 'Otac i sin idu u ribolov.' },
        { id: 37, sentence: 'Volim crtati šarene leptire.' },
        { id: 38, sentence: 'Vani pada jaka kiša.' },
        { id: 39, sentence: 'Danas učimo pisati nova slova.' },
        { id: 40, sentence: 'Moj djed ima veliki vrt.' },
        { id: 41, sentence: 'Uskoro su ljetni praznici.' },
        { id: 42, sentence: 'Idemo u kino gledati novi film.' },
        { id: 43, sentence: 'Na stolu je svježe voće.' },
        { id: 44, sentence: 'Zajedno radimo snjegovića.' },
        { id: 45, sentence: 'Olovka je na stolu.' },
        { id: 46, sentence: 'Slušamo glazbu na radiju.' },
        { id: 47, sentence: 'Moja obitelj živi u gradu.' },
        { id: 48, sentence: 'Volim jesti svježu salatu.' },
        { id: 49, sentence: 'Učim voziti bicikl.' },
        { id: 50, sentence: 'More je plavo i veliko.' },
      ],
      grammar: [
        { id: 1, sentence: 'Dječak ___ loptu.', blank: 'ima', options: ['ima', 'imaju', 'imamo'], explanation: 'Subjekt u jednini (dječak) zahtijeva glagol u trećem licu jednine (ima).' },
        { id: 2, sentence: 'Djevojčice se ___.', blank: 'igraju', options: ['igra', 'igraš', 'igraju'], explanation: 'Subjekt u množini (djevojčice) zahtijeva glagol u trećem licu množine (igraju).' },
        ...
        { id: 16, sentence: 'Ja ___ pismo.', blank: 'pišem', options: ['pišem', 'pišeš', 'piše'], explanation: 'Glagol "pisati" u prezentu za 1. lice jednine (ja) glasi "pišem".' },
        { id: 17, sentence: 'Ti ___ lijepo.', blank: 'pjevaš', options: ['pjevam', 'pjevaš', 'pjeva'], explanation: 'Glagol "pjevati" u prezentu za 2. lice jednine (ti) glasi "pjevaš".' },
        { id: 18, sentence: 'Ona ___ na moru.', blank: 'je', options: ['sam', 'si', 'je'], explanation: 'Glagol "biti" u prezentu za 3. lice jednine (ona) glasi "je".' },
        { id: 19, sentence: 'Lana ima ___ oči.', blank: 'plave', options: ['plav', 'plava', 'plave'], explanation: 'Imenica "oči" je u množini ženskog roda, pa pridjev mora biti u množini (plave).' },
        { id: 20, sentence: 'Dao sam knjigu ___.', blank: 'prijatelju', options: ['prijatelj', 'prijatelja', 'prijatelju'], explanation: 'Dativ (komu/čemu dajem?) zahtijeva nastavak -u za imenice muškog roda.' },
        { id: 21, sentence: 'Ovo je dar za ___.', blank: 'tebe', options: ['ti', 'tebe', 'tobom'], explanation: 'Prijedlog "za" zahtijeva akuzativ osobne zamjenice, što je "tebe".' },
        { id: 22, sentence: 'Nemam ___ vremena.', blank: 'puno', options: ['puno', 'pun', 'puna'], explanation: 'Uz genitiv (nemam čega?), koristi se prilog za količinu "puno".' },
        { id: 23, sentence: 'Djeca su ___ dvorištu.', blank: 'u', options: ['u', 'na', 's'], explanation: 'Prijedlog "u" se koristi za označavanje mjesta unutar nečega (u dvorištu).' },
        { id: 24, sentence: 'Jučer sam ___ u kino.', blank: 'išao', options: ['išao', 'idem', 'ići'], explanation: 'Perfekt (prošlo vrijeme) za 1. lice jednine muškog roda glasi "sam išao".' },
        { id: 25, sentence: 'Sutra ___ na izlet.', blank: 'idemo', options: ['idem', 'ideš', 'idemo'], explanation: 'Prezent se može koristiti za izražavanje bliske budućnosti. Za "mi" oblik je "idemo".' },
        { id: 26, sentence: '___ je najviša planina u Hrvatskoj.', blank: 'Dinara', options: ['Velebit', 'Dinara', 'Biokovo'], explanation: 'Činjenično znanje o zemljopisu.' },
        { id: 27, sentence: 'S kim ___ u šetnju?', blank: 'ideš', options: ['idem', 'ideš', 'ide'], explanation: 'Pitanje upućeno drugoj osobi ("ti") zahtijeva glagol u 2. licu jednine.' },
        { id: 28, sentence: 'Pas je ___ od mačke.', blank: 'veći', options: ['veći', 'velik', 'najveći'], explanation: 'Komparativ pridjeva "velik" je "veći".' },
        { id: 29, sentence: 'Volim jesti ___ juhu.', blank: 'bakinu', options: ['bakin', 'bakina', 'bakinu'], explanation: 'Akuzativ jednine ženskog roda (juhu) zahtijeva pridjev u istom padežu (bakinu).' },
        { id: 30, sentence: 'U ___ ima sedam dana.', blank: 'tjednu', options: ['danu', 'mjesecu', 'tjednu'], explanation: 'Logičko i činjenično znanje.' },
      ],
      reading: [
        {
          id: 1,
    ...
    '4-6': {
      ...
      spelling: [
        ...
        { id: 221, sentence: 'Vidio sam ga ___ u gradu.', blank: 'jučer', options: ['jučer', 'jučer', 'juče'] },
        { id: 222, sentence: 'Imam ___ iz matematike.', blank: 'peticu', options: ['peticu', 'peticu', 'peticu'] },
        { id: 223, sentence: 'On je moj ___ susjed.', blank: 'najdraži', options: ['najdraži', 'najdraži', 'najdraži'] },
        { id: 224, sentence: 'Volim jesti ___ juhu.', blank: 'pileću', options: ['pileću', 'pileću', 'pileću'] },
        { id: 225, sentence: '___ je glavni grad Hrvatske.', blank: 'Zagreb', options: ['Zagreb', 'Zagreb', 'Zagreb'] },
        { id: 226, sentence: 'U ___ se igraju djeca.', blank: 'pijesku', options: ['pijesku', 'pjesku', 'pijesku'] },
        { id: 227, sentence: 'Ne razumijem ___ pitanje.', blank: 'tvoje', options: ['tvoje', 'tvoe', 'tvoje'] },
        { id: 228, sentence: 'More je ___ i plavo.', blank: 'veliko', options: ['veliko', 'veliko', 'veliko'] },
        { id: 229, sentence: 'Luka ima ___ bicikl.', blank: 'novi', options: ['novi', 'novi', 'novi'] },
        { id: 230, sentence: 'Danas je ___ dan.', blank: 'sunčan', options: ['sunčan', 'sunćan', 'sunčan'] },
        { id: 231, sentence: 'Na ___ je svježe voće.', blank: 'stolu', options: ['stolu', 'stolu', 'stolu'] },
        { id: 232, sentence: 'Uskoro su zimski ___.', blank: 'praznici', options: ['praznici', 'praznici', 'praznici'] },
        { id: 233, sentence: 'Slušamo ___ na radiju.', blank: 'glazbu', options: ['glazbu', 'glazbu', 'muziku'] },
        { id: 234, sentence: 'Moja obitelj ___ u Splitu.', blank: 'živi', options: ['živi', 'živi', 'živi'] },
        { id: 235, sentence: 'Volim jesti ___ salatu.', blank: 'svježu', options: ['svježu', 'svježu', 'svježu'] },
        { id: 236, sentence: 'Učim voziti ___.', blank: 'automobil', options: ['automobil', 'auto', 'automobil'] },
        { id: 237, sentence: 'U ___ su mnoge knjige.', blank: 'knjižnici', options: ['knjižnici', 'biblioteci', 'knjižnici'] },
        { id: 238, sentence: 'Ona je ___ u kazalištu.', blank: 'glumica', options: ['glumica', 'glumica', 'glumica'] },
        { id: 239, sentence: 'Naš pas se zove ___.', blank: 'Piko', options: ['Piko', 'Piko', 'Piko'] },
        { id: 240, sentence: 'Idemo na ___ na Jadranu.', blank: 'ljetovanje', options: ['ljetovanje', 'ljetovanje', 'ljetovanje'] },
      ],
      sentences: [
        ...
        { id: 221, sentence: 'Luka Modrić je poznati hrvatski nogometaš.' },
        { id: 222, sentence: 'Posjetili smo Nacionalni park Plitvička jezera.' },
        { id: 223, sentence: 'Na proljeće priroda se budi i sve cvate.' },
        { id: 224, sentence: 'U rasporedu sati imamo pet predmeta danas.' },
        { id: 225, sentence: 'U slobodno vrijeme volim se baviti sportom.' },
        { id: 226, sentence: 'Moj omiljeni predmet u školi je povijest.' },
        { id: 227, sentence: 'Za vikend planiramo obiteljski izlet na Sljeme.' },
        { id: 228, sentence: 'Tehnologija napreduje nevjerojatnom brzinom svakoga dana.' },
        { id: 229, sentence: 'Učenje stranih jezika vrlo je korisno za budućnost.' },
        { id: 230, sentence: 'Komunikacija je ključ za rješavanje mnogih problema.' },
        { id: 231, sentence: 'Napisala je vrlo zanimljiv sastavak o prijateljstvu.' },
        { id: 232, sentence: 'Cijela obitelj se okupila za vrijeme blagdana.' },
        { id: 233, sentence: 'Danas je Svjetski dan zaštite okoliša.' },
        { id: 234, sentence: 'Moramo donijeti važnu odluku o našem projektu.' },
        { id: 235, sentence: 'U muzeju smo vidjeli mnogo zanimljivih izložaka.' },
      ],
      grammar: [
        ...
        { id: 216, sentence: 'Oni ___ sutra doći na zabavu.', blank: 'će', options: ['će', 'ću', 'ćemo'], explanation: 'Futur I. za 3. lice množine tvori se s pomoćnim glagolom "će".' },
        { id: 217, sentence: 'Ne znam ___ doći.', blank: 'kako', options: ['kako', 'zašto', 'gdje'], explanation: 'Upitna zamjenica "kako" uvodi zavisnu rečenicu kojom se pita za način.' },
        { id: 218, sentence: 'Luka je dječak ___ ima plave oči.', blank: 'koji', options: ['koji', 'koja', 'koje'], explanation: 'Odnosna zamjenica "koji" odnosi se na imenicu "dječak" (muški rod, jednina).' },
        { id: 219, sentence: 'Uzeo sam kišobran ___ pada kiša.', blank: 'jer', options: ['jer', 'iako', 'ali'], explanation: 'Veznik "jer" uvodi uzročnu rečenicu.' },
        { id: 220, sentence: 'Išli smo na izlet po ___ vremenu.', blank: 'lijepom', options: ['lijepom', 'lijepu', 'lijepih'], explanation: 'Prijedlog "po" s lokativom zahtijeva pridjev u lokativu (lijepom).' },
        { id: 221, sentence: 'Ona je ___ od svih u razredu.', blank: 'najbolja', options: ['bolja', 'dobra', 'najbolja'], explanation: 'Superlativ pridjeva "dobar" je "najbolji/najbolja/najbolje".' },
        { id: 222, sentence: 'Djevojčica ___ je darovan poklon je sretna.', blank: 'kojoj', options: ['koja', 'koju', 'kojoj'], explanation: 'Dativ (komu je darovan poklon?) zahtijeva odnosnu zamjenicu "kojoj".' },
        { id: 223, sentence: 'Pročitao sam sve knjige ___ si mi posudio.', blank: 'koje', options: ['koji', 'koje', 'koja'], explanation: 'Odnosna zamjenica "koje" odnosi se na "knjige" (ženski rod, množina, akuzativ).' },
        { id: 224, sentence: 'Veselim ___ tvom dolasku.', blank: 'se', options: ['se', 'si', 'mi'], explanation: 'Povratni glagol "veseliti se" zahtijeva povratnu zamjenicu "se".' },
        { id: 225, sentence: 'S kim ___ razgovarao?', blank: 'si', options: ['sam', 'si', 'je'], explanation: 'Perfekt za 2. lice jednine muškog roda (ti si razgovarao) koristi enklitiku "si".' },
        { id: 226, sentence: 'Ne sviđa mi ___ ovaj film.', blank: 'se', options: ['se', 'ga', 'mi'], explanation: 'Glagol "sviđati se" je povratni glagol i zahtijeva zamjenicu "se".' },
        { id: 227, sentence: 'To je ___ najdraža pjesma.', blank: 'moja', options: ['moj', 'moja', 'moje'], explanation: 'Imenica "pjesma" je ženskog roda, pa i posvojna zamjenica mora biti u ženskom rodu.' },
        { id: 228, sentence: 'Učenici su ___ na pitanja.', blank: 'odgovarali', options: ['odgovarao', 'odgovarala', 'odgovarali'], explanation: 'Subjekt u množini muškog roda (učenici) zahtijeva glagolski pridjev radni u istom rodu i broju.' },
        { id: 229, sentence: 'Ovo je problem o ___ moramo razmisliti.', blank: 'kojemu', options: ['koji', 'kojemu', 'kojega'], explanation: 'Lokativ (o komu/čemu moramo razmisliti?) zahtijeva odnosnu zamjenicu "kojemu".' },
        { id: 230, sentence: 'On je otišao ___ bi kupio kruh.', blank: 'kako', options: ['zato', 'kako', 'iako'], explanation: 'Namjerna rečenica se može uvesti veznikom "kako".' },
      ],
      reading: [
        {
          id: 201,
    ...
    '7-9': {
      ...
      sentences: [
        ...
        { id: 521, sentence: 'Njegov argument je bio logičan i dobro potkrijepljen.' },
        { id: 522, sentence: 'Kritičko mišljenje vještina je koja se uči i razvija.' },
        { id: 523, sentence: 'Rezultati istraživanja predstavljeni su na znanstvenoj konferenciji.' },
        { id: 524, sentence: 'Digitalna transformacija mijenja sve aspekte našeg društva.' },
        { id: 525, sentence: 'Rasprava o etičkim implikacijama umjetne inteligencije je nužna.' },
        { id: 526, sentence: 'Očuvanje kulturne baštine zadaća je svake generacije.' },
        { id: 527, sentence: 'Postavio je zanimljivu hipotezu o podrijetlu svemira.' },
        { id: 528, sentence: 'Globalno zatopljenje ima ozbiljne posljedice za ekosustave.' },
        { id: 529, sentence: 'Mediji imaju veliku odgovornost u oblikovanju javnoga mnijenja.' },
        { id: 530, sentence: 'Koncept održivoga razvoja postaje sve važniji u svijetu.' },
        { id: 531, sentence: 'Potrebno je pomno analizirati sve argumente prije donošenja zaključka.' },
        { id: 532, sentence: 'Njegova se teorija temelji na detaljnom istraživanju.' },
        { id: 533, sentence: 'Moramo razmotriti problem iz različitih perspektiva.' },
        { id: 534, sentence: 'Ključno je razumjeti temeljna načela demokracije.' },
        { id: 535, sentence: 'Dugoročna strategija nužna je za postizanje uspjeha.' },
      ],
      grammar: [
        ...
        { id: 516, sentence: 'Djevojka ___ kosa je duga je moja sestra.', blank: 'čija', options: ['čija', 'koja', 'koju'], explanation: 'Posvojno-odnosna zamjenica "čija" se koristi za iskazivanje pripadnosti.' },
        { id: 517, sentence: 'Kad bih imao više vremena, ___ bih više knjiga.', blank: 'čitao', options: ['čitam', 'čitao', 'ću čitati'], explanation: 'Kondicional I. (bih + glagolski pridjev radni) se koristi za izražavanje želje ili mogućnosti.' },
        { id: 518, sentence: 'Dokumenti su ___ na sigurno mjesto.', blank: 'spremljeni', options: ['spremili', 'spremljeni', 'spremaju'], explanation: 'Pasiv se tvori od pomoćnog glagola "biti" i glagolskog pridjeva trpnog (su spremljeni).' },
        { id: 519, sentence: 'Učinio je to ___ ikakve pomoći.', blank: 'bez', options: ['bez', 'sa', 'pored'], explanation: 'Prijedlog "bez" s genitivom se koristi za izražavanje odsustva nečega.' },
        { id: 520, sentence: 'Šetali smo ___ rijeke.', blank: 'uz', options: ['kroz', 'uz', 'na'], explanation: 'Prijedlog "uz" označava kretanje duž nečega.' },
        { id: 521, sentence: 'Ona je ___ u Ameriku.', blank: 'otputovala', options: ['otputovala', 'putuje', 'putovala bi'], explanation: 'Perfekt se koristi za radnju koja se dogodila i završila u prošlosti.' },
        { id: 522, sentence: 'Ovo je roman ___ sam ti pričao.', blank: 'o kojemu', options: ['koji', 'o kojemu', 'kojega'], explanation: 'Odnosna zamjenica u lokativu muškog roda "o kojemu".' },
        { id: 523, sentence: 'Da si me pitao, ja ___ ti rekao.', blank: 'bih bio', options: ['bih bio', 'bi bio', 'bih'], explanation: 'Kondicional II. za 1. lice jednine glasi "bio bih" (ili "bih bio").' },
        { id: 524, sentence: 'On je viši ___ ja.', blank: 'nego', options: ['od', 'nego', 'kao'], explanation: 'U hrvatskom standardu, u komparaciji se češće koristi veznik "nego".' },
        { id: 525, sentence: 'Sastanak će se održati ___ ureda.', blank: 'ispred', options: ['ispred', 'na', 'u'], explanation: 'Prijedlog "ispred" označava mjesto.' },
        { id: 526, sentence: '___ li vidio novi film?', blank: 'Jesi', options: ['Jesi', 'Da li si', 'Jesi li'], explanation: 'Upitni oblik perfekta tvori se inverzijom i upitnom česticom li, ili upitnom rječcom "je" + li.' },
        { id: 527, sentence: 'Oni su ___ na vrijeme.', blank: 'došli', options: ['došli', 'došla', 'došlo'], explanation: 'Glagolski pridjev radni mora biti u množini muškog roda (došli).' },
        { id: 528, sentence: 'Ne bih se ___ s tobom.', blank: 'složio', options: ['složio', 'slažem', 'složiti'], explanation: 'Uz kondicional "ne bih" ide glagolski pridjev radni.' },
        { id: 529, sentence: 'Cijeli je dan ___ kiša.', blank: 'padala', options: ['padala', 'padao', 'padalo'], explanation: 'Subjekt "kiša" je ženskog roda, stoga i glagol mora biti u ženskom rodu.' },
        { id: 530, sentence: 'Nadam se ___ će sve biti u redu.', blank: 'da', options: ['da', 'li', 'kako'], explanation: 'Izrična rečenica se uvodi veznikom "da".' },
      ],
      spelling: [
        ...
        { id: 521, sentence: 'Ne želim se ___ u tvoj posao.', blank: 'miješati', options: ['mješati', 'miješati', 'mješati'] },
        { id: 522, sentence: 'On je ___ na sve.', blank: 'utjecao', options: ['utjecao', 'uticao', 'utjekao'] },
        { id: 523, sentence: '___ se da ćeš uspjeti.', blank: 'Nadam', options: ['Nadam', 'Nadamo', 'Nada'] },
        { id: 524, sentence: 'Dao je ___ izjavu.', blank: 'službenu', options: ['službenu', 'službenu', 'službenu'] },
        { id: 525, sentence: 'Moramo izvršiti ___ podataka.', blank: 'analizu', options: ['analizu', 'analizu', 'analizu'] },
        { id: 526, sentence: 'Problem je ___ naravi.', blank: 'tehničke', options: ['tehničke', 'tehnićke', 'tehničke'] },
        { id: 527, sentence: 'Ovo je ___ procedura.', blank: 'standardna', options: ['standardna', 'standardna', 'štandardna'] },
        { id: 528, sentence: 'Njegov ___ je bio vrlo jasan.', blank: 'zaključak', options: ['zaključak', 'zakljućak', 'zaključak'] },
        { id: 529, sentence: 'To je bila ___ rasprava.', blank: 'konstruktivna', options: ['konstruktivna', 'konstruktivna', 'konstruktivna'] },
        { id: 530, sentence: 'Moramo se pridržavati ___.', blank: 'pravila', options: ['pravila', 'pravila', 'pravila'] },
      ],
      reading: [
        {
            id: 501,
  ...
  serbian: {
    '1-3': {
      ...
      spelling: [
        ...
        { id: 21, sentence: 'Voz ide po ___.', blank: 'šinama', options: ['šinama', 'šjinama', 'sinama'] },
        { id: 22, sentence: 'Moja ___ se zove Ana.', blank: 'sestra', options: ['sestra', 'seka', 'sestrična'] },
        { id: 23, sentence: 'Imam pet ___ na ruci.', blank: 'prstiju', options: ['prstiju', 'prsta', 'prstova'] },
        { id: 24, sentence: 'U šumi živi ___.', blank: 'medved', options: ['medvjed', 'medvijed', 'medved'] },
        { id: 25, sentence: '___ je slatko.', blank: 'Grožđe', options: ['Grožđe', 'Grozđe', 'Grožde'] },
        { id: 26, sentence: 'Video sam ___ na nebu.', blank: 'dugu', options: ['dugu', 'duhu', 'dugu'] },
        { id: 27, sentence: 'Danas je moj ___.', blank: 'rođendan', options: ['rođendan', 'rođendan', 'rodjendan'] },
        { id: 28, sentence: 'Ovo ___ auto.', blank: 'nije', options: ['nije', 'nie', 'nje'] },
        { id: 29, sentence: 'Ona ne ___ da dođe.', blank: 'želi', options: ['želi', 'želie', 'želji'] },
        { id: 30, sentence: 'Video sam ___ na nebu.', blank: 'zvezde', options: ['zvjezde', 'zvijezde', 'zvezde'] },
        { id: 31, sentence: 'Učiteljica je ocenila moj ___.', blank: 'domaći', options: ['domaći', 'domaći', 'domaći'] },
        { id: 32, sentence: 'Posetili smo glavni grad ___.', blank: 'Srbije', options: ['srbije', 'Srbije', 'Srbije'] },
        { id: 33, sentence: 'Voz za Niš kreće sa glavne ___.', blank: 'stanice', options: ['stanice', 'stanice', 'stanice'] },
        { id: 34, sentence: 'Leti volim da jedem sveže ___.', blank: 'povrće', options: ['povrće', 'povrče', 'povrce'] },
        { id: 35, sentence: 'Njegov ___ je lekar.', blank: 'stric', options: ['amidža', 'stric', 'daidža'] },
      ],
      sentences: [
        ...
        { id: 25, sentence: 'Idemo sutra na izlet.' },
        { id: 26, sentence: 'Jovan živi u Beogradu.' },
        { id: 27, sentence: 'Marko vozi novi bicikl.' },
        { id: 28, sentence: 'Volim da jedem topao hleb.' },
        { id: 29, sentence: 'Leti idemo na more.' },
        { id: 30, sentence: 'Moja porodica je velika.' },
        { id: 31, sentence: 'Učimo srpski jezik.' },
        { id: 32, sentence: 'Idemo u pozorište večeras.' },
        { id: 33, sentence: 'Učiteljica je vrlo ljubazna.' },
        { id: 34, sentence: 'Imam puno drugara.' },
        { id: 35, sentence: 'Danas je sunčan dan.' },
        { id: 36, sentence: 'Otac i sin idu na pecanje.' },
        { id: 37, sentence: 'Volim da crtam šarene leptire.' },
        { id: 38, sentence: 'Napolju pada jaka kiša.' },
        { id: 39, sentence: 'Danas učimo da pišemo nova slova.' },
        { id: 40, sentence: 'Moj deda ima veliku baštu.' },
        { id: 41, sentence: 'Uskoro će letnji raspust.' },
        { id: 42, sentence: 'Idemo u bioskop da gledamo novi film.' },
        { id: 43, sentence: 'Na stolu je sveže voće.' },
        { id: 44, sentence: 'Zajedno pravimo Sneška Belića.' },
        { id: 45, sentence: 'Olovka je na stolu.' },
      ],
      grammar: [
        ...
        { id: 6, sentence: 'Mi ___ u parku.', blank: 'smo', options: ['sam', 'si', 'smo'], explanation: 'Glagol "biti" u prezentu za 1. lice množine (mi) glasi "smo".' },
        { id: 7, sentence: 'Oni ___ iz Beograda.', blank: 'su', options: ['je', 'smo', 'su'], explanation: 'Glagol "biti" u prezentu za 3. lice množine (oni) glasi "su".' },
        { id: 8, sentence: 'Ovo je ___ auto.', blank: 'tatin', options: ['tatin', 'tatina', 'tatino'], explanation: 'Imenica "auto" je srednjeg roda, ali se prisvojni pridev slaže sa imenicom na koju se odnosi (tata), pa je "tatin" u muškom rodu, ali se može koristiti i za srednji rod.' },
        { id: 9, sentence: 'Mačka spava na ___.', blank: 'krovu', options: ['krov', 'krova', 'krovu'], explanation: 'Lokativ (gde spava?) zahteva nastavak -u za imenice muškog roda.' },
        { id: 10, sentence: 'Idem u školu ___ autobusom.', blank: 'sa', options: ['s', 'sa', 'za'], explanation: 'Predlog "sa" se koristi ispred suglasničkih grupa koje je teško izgovoriti sa "s".' },
        { id: 11, sentence: 'Jovana je ___ od Milice.', blank: 'viša', options: ['visoka', 'viša', 'najviša'], explanation: 'Komparativ od prideva "visok" glasi "viša".' },
        { id: 12, sentence: 'Učim ___ srpski jezik.', blank: 'da govorim', options: ['govoriti', 'da govorim', 'govoreći'], explanation: 'Konstrukcija "učiti da" se često koristi za izražavanje učenja veštine.' },
        { id: 13, sentence: 'Video sam ___ psa.', blank: 'velikog', options: ['velik', 'velikog', 'velikom'], explanation: 'Akuzativ (koga/šta vidim?) zahteva pridev u akuzativu muškog roda (velikog).' },
        { id: 14, sentence: 'Sedim na ___ stolici.', blank: 'maloj', options: ['mala', 'malu', 'maloj'], explanation: 'Lokativ (na čemu sedim?) zahteva pridev u lokativu ženskog roda (maloj).' },
        { id: 15, sentence: 'Danas ___ padati kiša.', blank: 'će', options: ['će', 'ću', 'ćemo'], explanation: 'Futur I za 3. lice jednine tvori se s pomoćnim glagolom "će".' },
        { id: 16, sentence: 'Ja ___ pismo.', blank: 'pišem', options: ['pišem', 'pišeš', 'piše'], explanation: 'Glagol "pisati" u prezentu za 1. lice jednine (ja) glasi "pišem".' },
        { id: 17, sentence: 'Ti ___ lepo.', blank: 'pevaš', options: ['pevam', 'pevaš', 'peva'], explanation: 'Glagol "pevati" u prezentu za 2. lice jednine (ti) glasi "pevaš".' },
        { id: 18, sentence: 'Ona ___ na moru.', blank: 'je', options: ['sam', 'si', 'je'], explanation: 'Glagol "biti" u prezentu za 3. lice jednine (ona) glasi "je".' },
        { id: 19, sentence: 'Jovan ima ___ oči.', blank: 'plave', options: ['plav', 'plava', 'plave'], explanation: 'Imenica "oči" je u množini ženskog roda, pa pridev mora biti u množini (plave).' },
        { id: 20, sentence: 'Dao sam svesku ___.', blank: 'drugarici', options: ['drugarica', 'drugaricu', 'drugarici'], explanation: 'Dativ (kome/čemu dajem?) zahteva nastavak -i za imenice ženskog roda.' },
      ],
      reading: [
        {
          id: 1,
    ...
    '4-6': { 
      ...
      spelling: [
        ...
        { id: 311, sentence: 'Nikad ne reci ___.', blank: 'nikad', options: ['nikad', 'nikada', 'nikad'] },
        { id: 312, sentence: 'Čuo sam ___ vesti.', blank: 'najnovije', options: ['najnovije', 'naj novije', 'najnovie'] },
        { id: 313, sentence: 'To je ___ nemoguće.', blank: 'potpuno', options: ['potpuno', 'podpuno', 'potpuno'] },
        { id: 314, sentence: 'On je moj ___ komšija.', blank: 'prvi', options: ['prvi', 'prvij', 'pervi'] },
        { id: 315, sentence: 'Uradio je to bez ___.', blank: 'greške', options: ['greške', 'grješke', 'grešaka'] },
        { id: 316, sentence: 'On je ___ na mene.', blank: 'ljut', options: ['ljut', 'ljut', 'besan'] },
        { id: 317, sentence: 'Ne znam ___ to da uradim.', blank: 'kako', options: ['kako', 'kako', 'kako'] },
        { id: 318, sentence: '___ ću ti pomoći.', blank: 'Pokušaću', options: ['Pokušaću', 'Pokušat ću', 'Pokušaću'] },
        { id: 319, sentence: 'Ovo je ___ film.', blank: 'najbolji', options: ['najbolji', 'naj bolji', 'najbolji'] },
        { id: 320, sentence: 'Molim te, donesi mi ___ vode.', blank: 'čašu', options: ['čašu', 'čaše', 'čaša'] },
        { id: 321, sentence: '___ sam ga video u gradu.', blank: 'Juče', options: ['Juče', 'jučer', 'jučer'] },
        { id: 322, sentence: 'Imam ___ iz matematike.', blank: 'peticu', options: ['peticu', 'peticu', 'peticu'] },
        { id: 323, sentence: 'On je moj ___ drug.', blank: 'najdraži', options: ['najdraži', 'najdraži', 'najdraži'] },
        { id: 324, sentence: 'Volim da jedem ___ supu.', blank: 'pileću', options: ['pileću', 'pileću', 'pileću'] },
        { id: 325, sentence: '___ je glavni grad Srbije.', blank: 'Beograd', options: ['Beograd', 'Beograd', 'Beograd'] },
      ], 
      sentences: [
        ...
        { id: 311, sentence: 'Planeta Zemlja se suočava sa klimatskim promenama.' },
        { id: 312, sentence: 'Internet je promenio način na koji komuniciramo.' },
        { id: 313, sentence: 'Zdrava ishrana je ključna za dobro zdravlje.' },
        { id: 314, sentence: 'Umetnost nam pomaže da izrazimo svoje emocije.' },
        { id: 315, sentence: 'Srbija ima bogato kulturno nasleđe.' },
        { id: 316, sentence: 'Obrazovanje otvara mnoga vrata u životu.' },
        { id: 317, sentence: 'Moramo čuvati našu životnu sredinu za buduće generacije.' },
        { id: 318, sentence: 'Volim da čitam knjige o dalekim zemljama.' },
        { id: 319, sentence: 'Svaki čovek ima pravo na slobodu i sreću.' },
        { id: 320, sentence: 'Sport nas uči timskom radu i disciplini.' },
        { id: 321, sentence: 'Novak Đoković je poznati srpski teniser.' },
        { id: 322, sentence: 'Posetili smo festival Guča u Dragačevu.' },
        { id: 323, sentence: 'U proleće se priroda budi i sve cveta.' },
        { id: 324, sentence: 'U rasporedu časova imamo pet predmeta danas.' },
        { id: 325, sentence: 'U slobodno vreme volim da se bavim sportom.' },
        { id: 326, sentence: 'Moj omiljeni predmet u školi je istorija.' },
        { id: 327, sentence: 'Za vikend planiramo porodični izlet na Avalu.' },
        { id: 328, sentence: 'Tehnologija napreduje neverovatnom brzinom svakoga dana.' },
        { id: 329, sentence: 'Učenje stranih jezika je veoma korisno za budućnost.' },
        { id: 330, sentence: 'Komunikacija je ključ za rešavanje mnogih problema.' },
      ], 
      grammar: [
        ...
        { id: 311, sentence: 'Dok ___ domaći, slušam muziku.', blank: 'radim', options: ['radim', 'raditi', 'radio'], explanation: 'Vremenska rečenica sa veznikom "dok" zahteva glagol u prezentu.' },
        { id: 312, sentence: 'Ovo je devojka ___ sam ti pričao.', blank: 'o kojoj', options: ['koja', 'koju', 'o kojoj'], explanation: 'Lokativ (o kome/čemu sam pričao?) zahteva odnosnu zamenicu u lokativu "o kojoj".' },
        { id: 313, sentence: 'Da sam znao, ___ ti pomogao.', blank: 'bio bih', options: ['bio bih', 'budem', 'ću'], explanation: 'Kondicional II (prošla mogućnost) tvori se od kondicionala I glagola "biti" (bio bih) i glagolskog prideva radnog (pomogao).' },
        { id: 314, sentence: 'Knjiga ___ je na stolu je moja.', blank: 'koja', options: ['koja', 'koje', 'koji'], explanation: 'Odnosna zamenica "koja" se odnosi na imenicu "knjiga" (ženski rod, jednina).' },
        { id: 315, sentence: '___ uči, taj će i znati.', blank: 'Ko', options: ['Ko', 'Šta', 'Koji'], explanation: 'Upitno-odnosna zamenica "ko" se koristi za živa bića u funkciji subjekta.' },
        { id: 316, sentence: 'Molim te, dodaj mi ___ soli.', blank: 'malo', options: ['malo', 'mnogo', 'nekoliko'], explanation: 'Za nebrojive imenice poput "so" koristi se prilog "malo".' },
        { id: 317, sentence: 'Svi ___ srećni zbog pobede.', blank: 'su bili', options: ['je bio', 'su bili', 'smo bili'], explanation: 'Perfekt za 3. lice množine muškog roda (svi) glasi "su bili".' },
        { id: 318, sentence: 'On je bolji ___ mene.', blank: 'od', options: ['od', 'nego', 'kao'], explanation: 'Komparativ se u srpskom jeziku tvori pomoću predloga "od".' },
        { id: 319, sentence: 'Kuća se nalazi ___ brda.', blank: 'pored', options: ['pored', 'na', 'u'], explanation: 'Predlog "pored" označava blizinu.' },
        { id: 320, sentence: 'Sedim ___ tebe.', blank: 'pored', options: ['pored', 'na', 'sa'], explanation: 'Predlog "pored" se koristi za označavanje mesta.' },
        { id: 321, sentence: 'Oni ___ sutra doći na žurku.', blank: 'će', options: ['će', 'ću', 'ćemo'], explanation: 'Futur I za 3. lice množine tvori se s pomoćnim glagolom "će".' },
        { id: 322, sentence: 'Ne znam ___ da dođem.', blank: 'kako', options: ['kako', 'zašto', 'gde'], explanation: 'Upitna zamenica "kako" uvodi zavisnu rečenicu kojom se pita za način.' },
        { id: 323, sentence: 'Miloš je dečak ___ ima plave oči.', blank: 'koji', options: ['koji', 'koja', 'koje'], explanation: 'Odnosna zamenica "koji" odnosi se na imenicu "dečak" (muški rod, jednina).' },
        { id: 324, sentence: 'Uzeo sam kišobran ___ pada kiša.', blank: 'jer', options: ['jer', 'iako', 'ali'], explanation: 'Veznik "jer" uvodi uzročnu rečenicu.' },
        { id: 325, sentence: 'Išli smo na izlet po ___ vremenu.', blank: 'lepom', options: ['lepom', 'lepu', 'lepih'], explanation: 'Predlog "po" s lokativom zahteva pridev u lokativu (lepom).' },
      ], 
      reading: [
        {
          id: 301,
    ...
    '7-9': {
      ...
      sentences: [
        ...
        { id: 611, sentence: 'Ljudska prava su temelj svakog pravednog društva.' },
        { id: 612, sentence: 'Filozofija postavlja pitanja o smislu postojanja.' },
        { id: 613, sentence: 'Psihologija proučava ljudsko ponašanje i mentalne procese.' },
        { id: 614, sentence: 'Kulturno nasleđe jednog naroda je od neprocenjive vrednosti.' },
        { id: 615, sentence: 'Veštačka inteligencija ima potencijal da transformiše naš svet.' },
        { id: 616, sentence: 'Važno je razvijati medijsku pismenost u digitalnom dobu.' },
        { id: 617, sentence: 'Održivi razvoj teži usklađivanju ekonomskih i ekoloških ciljeva.' },
        { id: 618, sentence: 'Civilni dijalog je neophodan za rešavanje društvenih sukoba.' },
        { id: 619, sentence: 'Inovacije u nauci i tehnologiji pokreću napredak čovečanstva.' },
        { id: 620, sentence: 'Socijalna pravda je cilj kojem bi sva društva trebalo da teže.' },
        { id: 621, sentence: 'Njegov argument je bio logičan i dobro potkrepljen.' },
        { id: 622, sentence: 'Kritičko mišljenje je veština koja se uči i razvija.' },
        { id: 623, sentence: 'Rezultati istraživanja su predstavljeni na naučnoj konferenciji.' },
        { id: 624, sentence: 'Digitalna transformacija menja sve aspekte našeg društva.' },
        { id: 625, sentence: 'Rasprava o etičkim implikacijama veštačke inteligencije je neophodna.' },
      ],
      grammar: [
        ...
        { id: 611, sentence: 'Svi su bili srećni ___ mene.', blank: 'osim', options: ['osim', 'pored', 'bez'], explanation: 'Predlog "osim" s genitivom se koristi za izuzimanje.' },
        { id: 612, sentence: 'Razgovarali smo o ___ problemima.', blank: 'različitim', options: ['različiti', 'različitim', 'različitih'], explanation: 'Lokativ množine (o čemu?) zahteva pridev u lokativu množine (različitim).' },
        { id: 613, sentence: 'Trebalo ___ da ranije dođeš.', blank: 'je', options: ['sam', 'si', 'je'], explanation: 'Bezlični glagolski oblik "trebalo je" se koristi za izražavanje obaveze u prošlosti.' },
        { id: 614, sentence: 'Pišem pismo ___ olovkom.', blank: 'novom', options: ['nova', 'novom', 'novoj'], explanation: 'Instrumental (čime pišem?) zahteva pridev u instrumentalu ženskog roda (novom).' },
        { id: 615, sentence: 'Ne znam ___ će doći.', blank: 'da li', options: ['da li', 'hoće li', 'bude li'], explanation: 'Upitna rečca "da li" uvodi zavisno-upitnu rečenicu.' },
        { id: 616, sentence: 'Oni ___ došli na vreme.', blank: 'nisu', options: ['nisu', 'nije', 'nismo'], explanation: 'Odrični oblik perfekta za 3. lice množine glasi "nisu".' },
        { id: 617, sentence: 'Da li ___ ikada bio u Italiji?', blank: 'si', options: ['si', 'sam', 'ste'], explanation: 'Upitni oblik perfekta za 2. lice jednine muškog roda.' },
        { id: 618, sentence: 'Učenici, ___ su uradili domaći, mogu da idu kući.', blank: 'koji', options: ['koji', 'koja', 'koje'], explanation: 'Odnosna zamenica "koji" u nominativu množine muškog roda.' },
        { id: 619, sentence: 'To je kuća u ___ sam odrastao.', blank: 'kojoj', options: ['koja', 'koju', 'kojoj'], explanation: 'Odnosna zamenica u lokativu jednine ženskog roda.' },
        { id: 620, sentence: 'On trči ___ od svih.', blank: 'najbrže', options: ['brže', 'brzo', 'najbrže'], explanation: 'Superlativ priloga "brzo" je "najbrže".' },
        { id: 621, sentence: 'Devojka ___ kosa je duga je moja sestra.', blank: 'čija', options: ['čija', 'koja', 'koju'], explanation: 'Prisvojno-odnosna zamenica "čija" se koristi za iskazivanje pripadnosti.' },
        { id: 622, sentence: 'Kada bih imao više vremena, ___ bih više knjiga.', blank: 'čitao', options: ['čitam', 'čitao', 'ću čitati'], explanation: 'Kondicional I (bih + glagolski pridev radni) se koristi za izražavanje želje ili mogućnosti.' },
        { id: 623, sentence: 'Dokumenti su ___ na sigurno mesto.', blank: 'sklonjeni', options: ['sklonili', 'sklonjeni', 'sklanjaju'], explanation: 'Pasiv se tvori od pomoćnog glagola "biti" i glagolskog prideva trpnog (su sklonjeni).' },
        { id: 624, sentence: 'On je uradio posao ___ ikakve pomoći.', blank: 'bez', options: ['bez', 'sa', 'pored'], explanation: 'Predlog "bez" s genitivom se koristi za izražavanje odsustva nečega.' },
        { id: 625, sentence: 'Šetali smo ___ reke.', blank: 'pored', options: ['kroz', 'pored', 'na'], explanation: 'Predlog "pored" označava kretanje duž nečega.' },
      ],
      spelling: [
        ...
        { id: 611, sentence: 'Njegova ___ je nepodnošljiva.', blank: 'drskost', options: ['drskost', 'drzskost', 'drskost'] },
        { id: 612, sentence: 'To je bio ___ potez.', blank: 'ishitren', options: ['ishitren', 'izhitren', 'ishitren'] },
        { id: 613, sentence: 'Moramo se boriti protiv ___.', blank: 'korupcije', options: ['korupcije', 'korumpcije', 'korupcie'] },
        { id: 614, sentence: 'Ovo je ___ prilika.', blank: 'jedinstvena', options: ['jedinstvena', 'jedinstvena', 'jedinstvenna'] },
        { id: 615, sentence: 'On je ___ za taj posao.', blank: 'kompetentan', options: ['kompetentan', 'kompetentan', 'konpetentan'] },
        { id: 616, sentence: '___ razvoj je ključan.', blank: 'Ekonomski', options: ['Ekonomski', 'Ekonomski', 'Ekonnomski'] },
        { id: 617, sentence: 'Dobili smo ___ odgovor.', blank: 'potvrdan', options: ['potvrdan', 'potvrdan', 'potvrda'] },
        { id: 618, sentence: 'Treba nam ___ rešenje.', blank: 'dugoročno', options: ['dugoročno', 'dugoroćno', 'dugoročno'] },
        { id: 619, sentence: '___ se ne isplati.', blank: 'Lenjost', options: ['Lijenost', 'Lenjost', 'Lenjost'] },
        { id: 620, sentence: 'To je pitanje ___.', blank: 'principa', options: ['principa', 'principa', 'principa'] },
        { id: 621, sentence: 'Uvek je bio ___ prema starijima.', blank: 'ljubazan', options: ['ljubazan', 'lubezan', 'ljubasan'] },
        { id: 622, sentence: 'Njegova izjava je izazvala ___.', blank: 'kontroverzu', options: ['kontroverzu', 'kontraverzu', 'kontrowerzu'] },
        { id: 623, sentence: 'Ne mogu da verujem u njegovu ___.', blank: 'naivnost', options: ['naivnost', 'naivnos', 'naivost'] },
        { id: 624, sentence: 'Ovo je ___ dokaz.', blank: 'nepobitan', options: ['nepobitan', 'nepobitan', 'nepobitan'] },
        { id: 625, sentence: 'Njegovo ponašanje je ___.', blank: 'neprihvatljivo', options: ['neprihvatljivo', 'neprihvatljivo', 'ne prihvatljivo'] },
      ],
      reading: [
        {
            id: 601,
