...
const chatbotFlow = ai.defineFlow(
  ...
  async ({ history, language, grade }) => {
    ...
    // The initial message containing context is now part of the history.
    const conversationHistory = [
        { role: 'model', content: `Kontekst za ovaj razgovor: Učenikov primarni jezik je ${language}, a razred je ${grade}.` },
        ...history,
    ];
